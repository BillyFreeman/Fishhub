...
public interface APIResponseConverter {
    ...
    List<DailyWeather> updateDailyWeatherList(WeatherDataDTO data, List<DailyWeather> weatherList) throws WeatherDataFormatException;

    List<H3PeriodWeather> convertToH3PeriodWeatherList(WeatherDataDTO data);
