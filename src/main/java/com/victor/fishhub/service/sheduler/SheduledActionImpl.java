    ...
    public void executeApiRequest() {
        if (locations != null && locations.hasNext()) {
            ...
            try {
                ...
                JAXBContext context = JAXBContext.newInstance(WeatherDataDTO.class);
                Unmarshaller unmarshaller = context.createUnmarshaller();

                WeatherDataDTO weatherData = (WeatherDataDTO) unmarshaller.unmarshal(connection.getInputStream());
